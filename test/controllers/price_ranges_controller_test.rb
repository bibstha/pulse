...
class PriceRangesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price_range" do
    assert_difference('PriceRange.count') do
      post price_ranges_url, params: { price_range: { description: @price_range.description, end_date: @price_range.end_date, start_date: @price_range.start_date, vendor_id: @price_range.vendor_id } }
    end
  ...
  test "should update price_range" do
    patch price_range_url(@price_range), params: { price_range: { description: @price_range.description, end_date: @price_range.end_date, start_date: @price_range.start_date, vendor_id: @price_range.vendor_id } }
